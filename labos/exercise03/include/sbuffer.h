...
/**
 * Removes the first sensor data in 'buffer' (at the 'head') and returns this element data as '*data'
 * If 'buffer' is empty, the function doesn't block until new element become available but returns SBUFFER_NO_DATA
